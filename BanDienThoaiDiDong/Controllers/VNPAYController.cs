...
namespace BanDienThoaiDiDong.Controllers
{
    public class VNPAYController : Controller
    {
        ...
        private void ThatBai(string orderId)
        {
            TempData["message"] = "Có lỗi xảy ra trong quá trình xử lý hóa đơn " + orderId;
        }
        private void ThanhCong(string orderID)
        {
            HDBAN hd = new HDBAN();
